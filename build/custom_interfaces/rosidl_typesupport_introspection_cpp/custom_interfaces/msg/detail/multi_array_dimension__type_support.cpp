...
{
  new (message_memory) custom_interfaces::msg::MultiArrayDimension(_init);
}

void MultiArrayDimension_fini_function(void * message_memory)
{
  auto typed_message = static_cast<custom_interfaces::msg::MultiArrayDimension *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember MultiArrayDimension_message_member_array[3] = {
  {
    ...
    offsetof(custom_interfaces::msg::MultiArrayDimension, label),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(custom_interfaces::msg::MultiArrayDimension, size),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(custom_interfaces::msg::MultiArrayDimension, stride),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers MultiArrayDimension_message_members = {
  ...
  3,  // number of fields
  sizeof(custom_interfaces::msg::MultiArrayDimension),
...
get_message_type_support_handle<custom_interfaces::msg::MultiArrayDimension>()
{
  return &::custom_interfaces::msg::rosidl_typesupport_introspection_cpp::MultiArrayDimension_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, custom_interfaces, msg, MultiArrayDimension)() {
  return &::custom_interfaces::msg::rosidl_typesupport_introspection_cpp::MultiArrayDimension_message_type_support_handle;
}
