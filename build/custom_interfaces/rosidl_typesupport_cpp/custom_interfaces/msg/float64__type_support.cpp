...
static const _Float64_type_support_symbol_names_t _Float64_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, custom_interfaces, msg, Float64)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, custom_interfaces, msg, Float64)),
  }
};
...
get_message_type_support_handle<custom_interfaces::msg::Float64>()
{
  return &::custom_interfaces::msg::rosidl_typesupport_cpp::Float64_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, custom_interfaces, msg, Float64)() {
  return get_message_type_support_handle<custom_interfaces::msg::Float64>();
}
