...
static const _MultiArrayLayout_type_support_symbol_names_t _MultiArrayLayout_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, custom_interfaces, msg, MultiArrayLayout)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, custom_interfaces, msg, MultiArrayLayout)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, custom_interfaces, msg, MultiArrayLayout)() {
  return &::custom_interfaces::msg::rosidl_typesupport_c::MultiArrayLayout_message_type_support_handle;
}
