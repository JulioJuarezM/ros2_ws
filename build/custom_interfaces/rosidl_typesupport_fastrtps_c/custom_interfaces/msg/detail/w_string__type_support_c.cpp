...
#include "custom_interfaces/msg/detail/w_string__rosidl_typesupport_fastrtps_c.h"
...
using _WString__ros_msg_type = custom_interfaces__msg__WString;
...
size_t get_serialized_size_custom_interfaces__msg__WString(
  const void * untyped_ros_message,
...
static uint32_t _WString__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_custom_interfaces__msg__WString(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_custom_interfaces
size_t max_serialized_size_custom_interfaces__msg__WString(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = custom_interfaces__msg__WString;
    is_plain =
      (
...
static size_t _WString__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_custom_interfaces__msg__WString(
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, custom_interfaces, msg, WString)() {
