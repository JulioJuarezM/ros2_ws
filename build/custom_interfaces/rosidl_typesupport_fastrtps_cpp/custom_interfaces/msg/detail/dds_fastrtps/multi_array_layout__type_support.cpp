...
#include "custom_interfaces/msg/detail/multi_array_layout__rosidl_typesupport_fastrtps_cpp.hpp"
...
{
bool cdr_serialize(
  const custom_interfaces::msg::MultiArrayDimension &,
  eprosima::fastcdr::Cdr &);
bool cdr_deserialize(
  eprosima::fastcdr::Cdr &,
  custom_interfaces::msg::MultiArrayDimension &);
...
cdr_serialize(
  const custom_interfaces::msg::MultiArrayLayout & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  custom_interfaces::msg::MultiArrayLayout & ros_message)
{
  // Member: dim
  {
    uint32_t cdrSize;
  ...
  size_t current_alignment)
{
  ...
  // Member: dim
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        custom_interfaces::msg::typesupport_fastrtps_cpp::max_serialized_size_MultiArrayDimension(
  ...
  if (is_plain) {
    ...
    using DataType = custom_interfaces::msg::MultiArrayLayout;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const custom_interfaces::msg::MultiArrayLayout *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<custom_interfaces::msg::MultiArrayLayout *>(
    untyped_ros_message);
...
{
  return &custom_interfaces::msg::typesupport_fastrtps_cpp::_MultiArrayLayout__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, custom_interfaces, msg, MultiArrayLayout)() {
  return &custom_interfaces::msg::typesupport_fastrtps_cpp::_MultiArrayLayout__handle;
}
