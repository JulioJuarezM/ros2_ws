...
#include "custom_interfaces/msg/detail/multi_array_dimension__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const custom_interfaces::msg::MultiArrayDimension & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  custom_interfaces::msg::MultiArrayDimension & ros_message)
{
  // Member: label
  cdr >> ros_message.label;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = custom_interfaces::msg::MultiArrayDimension;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const custom_interfaces::msg::MultiArrayDimension *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<custom_interfaces::msg::MultiArrayDimension *>(
    untyped_ros_message);
...
{
  return &custom_interfaces::msg::typesupport_fastrtps_cpp::_MultiArrayDimension__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, custom_interfaces, msg, MultiArrayDimension)() {
  return &custom_interfaces::msg::typesupport_fastrtps_cpp::_MultiArrayDimension__handle;
}
