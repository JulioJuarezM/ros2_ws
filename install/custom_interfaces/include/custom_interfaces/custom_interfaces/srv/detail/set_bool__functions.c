...
custom_interfaces__srv__SetBool_Request__create()
{
  ...
  custom_interfaces__srv__SetBool_Request * msg = (custom_interfaces__srv__SetBool_Request *)allocator.allocate(sizeof(custom_interfaces__srv__SetBool_Request), allocator.state);
  if (!msg) {
    return NULL;
  }
...
custom_interfaces__srv__SetBool_Request__Sequence__init(custom_interfaces__srv__SetBool_Request__Sequence * array, size_t size)
{
  ...
  if (size) {
    data = (custom_interfaces__srv__SetBool_Request *)allocator.zero_allocate(size, sizeof(custom_interfaces__srv__SetBool_Request), allocator.state);
    if (!data) {
      return false;
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  custom_interfaces__srv__SetBool_Request__Sequence * array = (custom_interfaces__srv__SetBool_Request__Sequence *)allocator.allocate(sizeof(custom_interfaces__srv__SetBool_Request__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  ...
  custom_interfaces__srv__SetBool_Request__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    ...
    custom_interfaces__srv__SetBool_Request * data =
      (custom_interfaces__srv__SetBool_Request *)allocator.reallocate(
    ...
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!custom_interfaces__srv__SetBool_Request__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          custom_interfaces__srv__SetBool_Request__fini(&output->data[i]);
        }
        return false;
      }
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  custom_interfaces__srv__SetBool_Response * msg = (custom_interfaces__srv__SetBool_Response *)allocator.allocate(sizeof(custom_interfaces__srv__SetBool_Response), allocator.state);
  if (!msg) {
    return NULL;
  }
...
custom_interfaces__srv__SetBool_Response__Sequence__init(custom_interfaces__srv__SetBool_Response__Sequence * array, size_t size)
{
  ...
  if (size) {
    data = (custom_interfaces__srv__SetBool_Response *)allocator.zero_allocate(size, sizeof(custom_interfaces__srv__SetBool_Response), allocator.state);
    if (!data) {
      return false;
    }
    // initialize all array elements
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  custom_interfaces__srv__SetBool_Response__Sequence * array = (custom_interfaces__srv__SetBool_Response__Sequence *)allocator.allocate(sizeof(custom_interfaces__srv__SetBool_Response__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  ...
  custom_interfaces__srv__SetBool_Response__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    ...
    custom_interfaces__srv__SetBool_Response * data =
      (custom_interfaces__srv__SetBool_Response *)allocator.reallocate(
      output->data, allocation_size, allocator.state);
    if (!data) {
      return false;
    }
    ...
    output->data = data;
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!custom_interfaces__srv__SetBool_Response__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          custom_interfaces__srv__SetBool_Response__fini(&output->data[i]);
        }
        return false;
      }
    }
