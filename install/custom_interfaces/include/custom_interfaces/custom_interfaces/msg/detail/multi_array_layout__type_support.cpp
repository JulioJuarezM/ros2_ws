...
{
  new (message_memory) custom_interfaces::msg::MultiArrayLayout(_init);
}

void MultiArrayLayout_fini_function(void * message_memory)
{
  auto typed_message = static_cast<custom_interfaces::msg::MultiArrayLayout *>(message_memory);
  typed_message->~MultiArrayLayout();
}

size_t size_function__MultiArrayLayout__dim(const void * untyped_member)
{
  const auto * member = reinterpret_cast<const std::vector<custom_interfaces::msg::MultiArrayDimension> *>(untyped_member);
  return member->size();
}
...
{
  const auto & member =
    *reinterpret_cast<const std::vector<custom_interfaces::msg::MultiArrayDimension> *>(untyped_member);
  return &member[index];
}
...
{
  auto & member =
    *reinterpret_cast<std::vector<custom_interfaces::msg::MultiArrayDimension> *>(untyped_member);
  return &member[index];
}
...
{
  const auto & item = *reinterpret_cast<const custom_interfaces::msg::MultiArrayDimension *>(
    get_const_function__MultiArrayLayout__dim(untyped_member, index));
  auto & value = *reinterpret_cast<custom_interfaces::msg::MultiArrayDimension *>(untyped_value);
  value = item;
}
...
{
  auto & item = *reinterpret_cast<custom_interfaces::msg::MultiArrayDimension *>(
    get_function__MultiArrayLayout__dim(untyped_member, index));
  const auto & value = *reinterpret_cast<const custom_interfaces::msg::MultiArrayDimension *>(untyped_value);
  item = value;
}
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember MultiArrayLayout_message_member_array[2] = {
  {
    ...
    ::rosidl_typesupport_introspection_cpp::get_message_type_support_handle<custom_interfaces::msg::MultiArrayDimension>(),  // members of sub message
    true,  // is array
    0,  // array size
    false,  // is upper bound
    offsetof(custom_interfaces::msg::MultiArrayLayout, dim),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(custom_interfaces::msg::MultiArrayLayout, data_offset),  // bytes offset in struct
    nullptr,  // default value
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers MultiArrayLayout_message_members = {
  ...
  2,  // number of fields
  sizeof(custom_interfaces::msg::MultiArrayLayout),
...
get_message_type_support_handle<custom_interfaces::msg::MultiArrayLayout>()
{
  return &::custom_interfaces::msg::rosidl_typesupport_introspection_cpp::MultiArrayLayout_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, custom_interfaces, msg, MultiArrayLayout)() {
  return &::custom_interfaces::msg::rosidl_typesupport_introspection_cpp::MultiArrayLayout_message_type_support_handle;
}
