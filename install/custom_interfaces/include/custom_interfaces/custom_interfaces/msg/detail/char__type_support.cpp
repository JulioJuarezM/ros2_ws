...
{
  new (message_memory) custom_interfaces::msg::Char(_init);
}

void Char_fini_function(void * message_memory)
{
  auto typed_message = static_cast<custom_interfaces::msg::Char *>(message_memory);
  typed_message->~Char();
}
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember Char_message_member_array[1] = {
  {
    ...
    offsetof(custom_interfaces::msg::Char, data),  // bytes offset in struct
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers Char_message_members = {
  ...
  "Char",  // message name
  1,  // number of fields
  sizeof(custom_interfaces::msg::Char),
...
{
  return &::custom_interfaces::msg::rosidl_typesupport_introspection_cpp::Char_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, custom_interfaces, msg, Char)() {
  return &::custom_interfaces::msg::rosidl_typesupport_introspection_cpp::Char_message_type_support_handle;
}
