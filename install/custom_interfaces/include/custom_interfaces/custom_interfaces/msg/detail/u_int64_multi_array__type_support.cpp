...
{
  new (message_memory) custom_interfaces::msg::UInt64MultiArray(_init);
}

void UInt64MultiArray_fini_function(void * message_memory)
{
  auto typed_message = static_cast<custom_interfaces::msg::UInt64MultiArray *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember UInt64MultiArray_message_member_array[2] = {
  {
    ...
    offsetof(custom_interfaces::msg::UInt64MultiArray, layout),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(custom_interfaces::msg::UInt64MultiArray, data),  // bytes offset in struct
    nullptr,  // default value
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers UInt64MultiArray_message_members = {
  ...
  2,  // number of fields
  sizeof(custom_interfaces::msg::UInt64MultiArray),
...
{
  return &::custom_interfaces::msg::rosidl_typesupport_introspection_cpp::UInt64MultiArray_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, custom_interfaces, msg, UInt64MultiArray)() {
  return &::custom_interfaces::msg::rosidl_typesupport_introspection_cpp::UInt64MultiArray_message_type_support_handle;
}
